<?php
namespace Drupal\promo_banner\Plugin\Block;

use Drupal\Core\Block\BlockBase;
use Drupal\Core\Form\FormStateInterface;
/**
 * Provides a 'Promo_banner' Block.
 *
 * @Block(
 ...
 * )
 */
class Promo_bannerBlock extends BlockBase {
  /**
   * {@inheritdoc}
   */
  ...
  {
    $token = \Drupal::csrfToken()->get('promo_banner');
    ...
    $ret =  [
      ...
      '#attached' => [
        'library' => [
          'promo_banner/promo_banner-styles',
        ],
      ],
    ];
